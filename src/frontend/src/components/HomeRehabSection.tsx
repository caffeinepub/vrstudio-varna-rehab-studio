...
import { HOME_REHAB_BG } from "../constants";
        ...
        <FadeInSection>
          <div className="text-center mb-14">
            ...
            <p className="text-white/75 max-w-2xl mx-auto leading-relaxed">
              Предлагам домашна рехабилитация за пациенти, на които им е трудно
              да посещават кабинета. Работя директно при вас, с пълно оборудване
              и индивидуална програма.
            </p>
          </div>
        </FadeInSection>
